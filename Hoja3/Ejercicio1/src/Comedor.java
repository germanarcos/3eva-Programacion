...
public class Comedor {
	...
	public static Ingrediente[] crearIngredientes() {
		String nombres[] = { "Croquetas", "Pimientos", "Mortadela", "Champiñones", "Ternera", "Tortilla", "Huevos",
				"Atún", "Jamón", "Espárragos", "Patatas", "Cebolla", "Anís" , "Orégano", "Queso", "Tomate", "Cebolla",
				"Pimiento", "Macarrones", "Bacon", "Zanahoria", "Chorizo", "Morcilla", "Berenjena","Boloñesa","Roquefort","Sopa",
